## wootctl automation-rules create

Create a automation-rule

```
wootctl automation-rules create [flags]
```

### Examples

```
  wootctl automation-rules create --data '{...}'
  wootctl automation-rules create -d @payload.json
```
