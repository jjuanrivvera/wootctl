## wootctl client contacts update

Update a public contact

```
wootctl client contacts update <inbox-identifier> <contact-identifier> [flags]
```

### Examples

```
  wootctl client contacts update Fbd1h… c7f3… --name "Ana María"
```
