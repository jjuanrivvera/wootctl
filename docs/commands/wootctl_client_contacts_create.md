## wootctl client contacts create

Create a contact in a public inbox

```
wootctl client contacts create <inbox-identifier> [flags]
```

### Examples

```
  wootctl client contacts create Fbd1h… --name Ana --email ana@example.com
```
